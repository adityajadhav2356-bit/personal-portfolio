...
const Footer = () => {
  return (
    <footer className="border-t border-slate-800 py-12 relative z-10 bg-slate-950/50 backdrop-blur-lg">
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center">
        
        <div className="mb-6 md:mb-0">
          <a href="#" className="text-xl font-bold tracking-tighter bg-gradient-to-r from-accent-400 to-accent-400 bg-clip-text text-transparent">
            Aaditya.
          </a>
